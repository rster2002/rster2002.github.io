...
for (var i = 0; i < races.length; ++i) {
	...
	$(".cardList").append("<div class='card'><h1 id='name'>" + raceName + "</h1><div class='misc'><h1>Size: " + race.size + "</h1><h1>Speed: " + race.speed + "</h1></div><div class='modifiers'><div class='colom1'><h1>Str: " + modifiers.strength + "</h1><h1>Dex: " + modifiers.dexterity + "</h1><h1>Con: " + modifiers.constitution + "</h1></div><div class='colom2'><h1>Int: " + modifiers.intelligence + "</h1><h1>Wis: " + modifiers.wisdom + "</h1><h1>Cha: " + modifiers.charisma + "</h1></div></div><div class='languages'><h1>Languages</h1>" + languages + "</div></div>");
}