<template lang="html">
    <div>
        <sidebar>
            ...
            <sidebar-item @click="openSection('tasks')" icon="done"
                >Tasks</sidebar-item
            >
            <sidebar-item @click="openSection('workers')" icon="group"
                >Workers</sidebar-item
            >
            <sidebar-item @click="openSection('timeline')" icon="timeline"
                >Timeline</sidebar-item
            >
            <sidebar-item @click="goto()" class="btm" icon="home"
                >Home</sidebar-item
            >
        </sidebar>
...
export default {
    ...
    methods: {
        ...
        openSection(s) {
            ...
            this.$router.push({
                path: `/repo/${params.user}/${params.repo}/${s}`
            });
        },
        goto() {
