<template lang="html">
    <div class="textBox" :class="{ err: v.length > ml }">
        <div class="textBoxInner" :class="{ f: focus, textarea: type === 'textarea', mb: ht !== '' }" @click="f()">
...
.textBox {
    ...
    .helpertext {
        ...
        font-size: 12px;
        margin-top: 4px;
        color: $textBoxHelperTextFontColor;
        font-family: $textBoxFontFamily;
    }

    &.err {
        .textBox {
            border-color: $textBoxErrorColor;
    ...
    .textBoxInner {
        ...
        height: $size + 12px;
        width: calc(100% - 4px);
        border: 2px solid $textBoxBorderBlurColor;
        ...
        &.f {
            border: 2px solid $textBoxBorderFocusColor;
        }
